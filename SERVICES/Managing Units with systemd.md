...
2. `/etc/systemd/system/<service>.d`: Service files overrides go here
3. `/run/systemd/system` - runtime unit files. Do NOT edit
4. `/usr/lib/systemd/system` - unit files generated by RPM packages. Do NOT edit
